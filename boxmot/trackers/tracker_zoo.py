...
REID_TRACKERS = ["strongsort", "botsort", "deepocsort", "hybridsort", "boosttrack", "imprassoc"]
...
TRACKER_MAPPING = {
    ...
    "cbiou"     : "boxmot.trackers.cbiou.cbiou.CBIoU",  # ✅ 新增這一行
    "imprassoc": "boxmot.trackers.imprassoc.imprassoc.ImprAssocTrack",  # 新增這行
    "fasttracker":"boxmot.trackers.fasttracker.fasttracker.FastTracker",# 新增這行
}
